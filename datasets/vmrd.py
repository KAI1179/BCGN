...
class vmrd(pascal_voc):
    ...
    def __init__(self, image_set, version = 'compv2', use07metric = True, devkit_path=None):
        ...
        self._classes = ['__background__',  # always index 0  ## 31 categories
